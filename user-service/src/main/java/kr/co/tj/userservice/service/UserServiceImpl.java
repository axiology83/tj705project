...
import kr.co.tj.userservice.persistence.UserRepository;
...
public class UserServiceImpl implements UserService {
	...
	public UserDTO updateUser(UserDTO userDTO) {
		...
		UserEntity entity = UserEntity.builder().id(orgDTO.getId()).username(orgDTO.getUsername())
				.password(userDTO.getPassword()).name(userDTO.getName()).createAt(orgDTO.getCreateAt()).updateAt(date)
				.build();
	...
	// 날짜정보 주입
	@Override
	public UserDTO setDate(UserDTO userDTO) {
		Date date = new Date();
